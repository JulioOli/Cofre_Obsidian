...
> Material de apoio para uso do SAGI e de outros sistemas no dia a dia da Controladoria G3S.
...
| **Supply**         | Bracofer                     | Sistema da Loja - tem as notas de vendas de ferro novo                       |
...
> Na **Seletiva**, o caso mais comum é **`1.2.x.2`** (compra) e **`2.2.x.2`** (venda) por filial — ver [[Filiais (nível 2)]] e [[Departamentos (nível 3)]].
...
[[Estrutura Empresarial G3S]] · [[Divisões (nível 1)]] · [[Tipos de Movimentação]] · [[Analise Base Financeira]] · [[Índice Controladoria]]
